    ...
    @if (client(); as c) {
      <app-card>
        ...
        <app-card-content>
          ...
          <!-- ── Mode lecture ─────────────────────────────────────── -->
          @if (!editing()) {
            <p class="text-xs font-bold text-muted-foreground uppercase tracking-wide mb-2">
              Identification
            </p>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 mb-4">
              @if (c.tpePme) {
                <div class="flex justify-between py-1.5 border-b border-border/40">
                  <span class="text-xs text-muted-foreground">Categorie Entreprise </span>
              ...
              @if (c.sexe) {
                <div class="flex justify-between py-1.5 border-b border-border/40">
                  ...
                  <span class="text-xs font-medium text-foreground">{{ c.sexe }}</span>
                </div>
              }
              ...
              @if (c.dateInscription) {
                <div class="flex justify-between py-1.5 border-b border-border/40">
                  ...
                  <span class="text-xs font-medium text-foreground">{{
                    c.dateInscription | date: 'dd/MM/yyyy'
                  }}</span>
                </div>
              }
            </div>
